...
public class SpaceScene : GameScene
{
    ...
    public override void Draw(SpriteBatch spriteBatch)
    {
        ...
        _wireframeRenderer.Draw(cube, cubeWorld, _view, _projection, spriteBatch, highlightedEdgeIndex: _debugHighlightedEdge, drawHiddenEdges: _gameInstance?.DrawInvisible ?? false, drawWhite: _gameInstance?.DrawWhite ?? false);
        ...
        foreach (var entity in _bubbleManager.GetAllActive())
        {
                ...
                entity.Blueprint.Name != "Sun")
            {
                ...
                _wireframeRenderer.Draw(entity.Blueprint.Model, entityWorld, _view, _projection, spriteBatch, drawHiddenEdges: _gameInstance?.DrawInvisible ?? false, drawWhite: _gameInstance?.DrawWhite ?? false);
            }
        }
        ...
        if (_bubbleManager.Planet?.Blueprint?.Model != null)
        {
            ...
            _wireframeRenderer.Draw(_bubbleManager.Planet.Blueprint.Model, world, _view, _projection, spriteBatch, drawHiddenEdges: _gameInstance?.DrawInvisible ?? false, drawWhite: _gameInstance?.DrawWhite ?? false);
        }
