...
public interface IGameContext
{
    ...
    /// <summary>Combat and laser fire service.</summary>
    Systems.ICombatService Combat { get; }
    ...
    /// <summary>On-screen message system.</summary>
    Systems.IMessageSystem Messages { get; }
